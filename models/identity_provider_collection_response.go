...
func (m *IdentityProviderCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *IdentityProviderCollectionResponse) GetOdataNextLink() *string {
...
func (m *IdentityProviderCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *IdentityProviderCollectionResponse) SetOdataNextLink(value *string) {
