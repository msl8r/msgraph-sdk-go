...
func (m *PrintOperationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrintOperationCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrintOperationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrintOperationCollectionResponse) SetOdataNextLink(value *string) {
