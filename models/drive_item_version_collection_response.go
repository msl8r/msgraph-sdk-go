...
func (m *DriveItemVersionCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DriveItemVersionCollectionResponse) GetOdataNextLink() *string {
...
func (m *DriveItemVersionCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DriveItemVersionCollectionResponse) SetOdataNextLink(value *string) {
