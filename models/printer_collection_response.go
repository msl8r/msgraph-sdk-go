...
func (m *PrinterCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrinterCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrinterCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrinterCollectionResponse) SetOdataNextLink(value *string) {
