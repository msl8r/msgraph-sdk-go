...
func (m *DeviceCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceCollectionResponse) SetOdataNextLink(value *string) {
