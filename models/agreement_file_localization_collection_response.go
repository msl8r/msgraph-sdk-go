...
func (m *AgreementFileLocalizationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *AgreementFileLocalizationCollectionResponse) GetOdataNextLink() *string {
...
func (m *AgreementFileLocalizationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AgreementFileLocalizationCollectionResponse) SetOdataNextLink(value *string) {
