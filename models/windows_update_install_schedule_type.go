...
func CreateWindowsUpdateInstallScheduleTypeFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	if parseNode != nil {
...
func (m *WindowsUpdateInstallScheduleType) GetAdditionalData() map[string]interface{} {
...
func (m *WindowsUpdateInstallScheduleType) SetAdditionalData(value map[string]interface{}) {
