...
func (m *DeviceConfigurationAssignmentCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceConfigurationAssignmentCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceConfigurationAssignmentCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceConfigurationAssignmentCollectionResponse) SetOdataNextLink(value *string) {
