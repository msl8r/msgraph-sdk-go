...
func (m *TeamsAppCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *TeamsAppCollectionResponse) GetOdataNextLink() *string {
...
func (m *TeamsAppCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *TeamsAppCollectionResponse) SetOdataNextLink(value *string) {
