...
func (m *Fido2AuthenticationMethodCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *Fido2AuthenticationMethodCollectionResponse) GetOdataNextLink() *string {
...
func (m *Fido2AuthenticationMethodCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *Fido2AuthenticationMethodCollectionResponse) SetOdataNextLink(value *string) {
