...
func (m *DeviceEnrollmentConfigurationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceEnrollmentConfigurationCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceEnrollmentConfigurationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceEnrollmentConfigurationCollectionResponse) SetOdataNextLink(value *string) {
