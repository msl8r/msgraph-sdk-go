...
func (m *OrganizationalBrandingLocalizationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OrganizationalBrandingLocalizationCollectionResponse) GetOdataNextLink() *string {
...
func (m *OrganizationalBrandingLocalizationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OrganizationalBrandingLocalizationCollectionResponse) SetOdataNextLink(value *string) {
