...
func (m *DirectoryRoleTemplateCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DirectoryRoleTemplateCollectionResponse) GetOdataNextLink() *string {
...
func (m *DirectoryRoleTemplateCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DirectoryRoleTemplateCollectionResponse) SetOdataNextLink(value *string) {
