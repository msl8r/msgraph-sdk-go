...
func (m *TeamsAppInstallationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *TeamsAppInstallationCollectionResponse) GetOdataNextLink() *string {
...
func (m *TeamsAppInstallationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *TeamsAppInstallationCollectionResponse) SetOdataNextLink(value *string) {
