...
func (m *WorkforceIntegrationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *WorkforceIntegrationCollectionResponse) GetOdataNextLink() *string {
...
func (m *WorkforceIntegrationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WorkforceIntegrationCollectionResponse) SetOdataNextLink(value *string) {
