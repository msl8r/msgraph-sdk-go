...
func (m *PrintConnectorCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrintConnectorCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrintConnectorCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrintConnectorCollectionResponse) SetOdataNextLink(value *string) {
