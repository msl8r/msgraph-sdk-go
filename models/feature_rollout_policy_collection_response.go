...
func (m *FeatureRolloutPolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *FeatureRolloutPolicyCollectionResponse) GetOdataNextLink() *string {
...
func (m *FeatureRolloutPolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *FeatureRolloutPolicyCollectionResponse) SetOdataNextLink(value *string) {
