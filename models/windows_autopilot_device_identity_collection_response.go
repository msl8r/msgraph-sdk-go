...
func (m *WindowsAutopilotDeviceIdentityCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *WindowsAutopilotDeviceIdentityCollectionResponse) GetOdataNextLink() *string {
...
func (m *WindowsAutopilotDeviceIdentityCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WindowsAutopilotDeviceIdentityCollectionResponse) SetOdataNextLink(value *string) {
