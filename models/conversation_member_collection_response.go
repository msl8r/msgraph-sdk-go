...
func (m *ConversationMemberCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ConversationMemberCollectionResponse) GetOdataNextLink() *string {
...
func (m *ConversationMemberCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *ConversationMemberCollectionResponse) SetOdataNextLink(value *string) {
