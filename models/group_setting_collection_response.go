...
func (m *GroupSettingCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *GroupSettingCollectionResponse) GetOdataNextLink() *string {
...
func (m *GroupSettingCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *GroupSettingCollectionResponse) SetOdataNextLink(value *string) {
