...
func (m *PrinterShareCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrinterShareCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrinterShareCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrinterShareCollectionResponse) SetOdataNextLink(value *string) {
