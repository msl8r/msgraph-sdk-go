...
func (m *ProvisioningObjectSummaryCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ProvisioningObjectSummaryCollectionResponse) GetOdataNextLink() *string {
...
func (m *ProvisioningObjectSummaryCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *ProvisioningObjectSummaryCollectionResponse) SetOdataNextLink(value *string) {
