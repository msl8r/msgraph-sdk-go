...
func (m *EducationOutcomeCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationOutcomeCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationOutcomeCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationOutcomeCollectionResponse) SetOdataNextLink(value *string) {
