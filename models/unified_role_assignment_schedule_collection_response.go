...
func (m *UnifiedRoleAssignmentScheduleCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *UnifiedRoleAssignmentScheduleCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleAssignmentScheduleCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UnifiedRoleAssignmentScheduleCollectionResponse) SetOdataNextLink(value *string) {
