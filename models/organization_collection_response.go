...
func (m *OrganizationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OrganizationCollectionResponse) GetOdataNextLink() *string {
...
func (m *OrganizationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OrganizationCollectionResponse) SetOdataNextLink(value *string) {
