...
func (m *WindowsInformationProtectionNetworkLearningSummaryCollectionResponse) GetOdataNextLink() *string {
...
func (m *WindowsInformationProtectionNetworkLearningSummaryCollectionResponse) SetOdataNextLink(value *string) {
