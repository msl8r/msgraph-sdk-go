...
func (m *OnenoteResourceCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OnenoteResourceCollectionResponse) GetOdataNextLink() *string {
...
func (m *OnenoteResourceCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OnenoteResourceCollectionResponse) SetOdataNextLink(value *string) {
