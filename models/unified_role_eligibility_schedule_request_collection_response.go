...
func (m *UnifiedRoleEligibilityScheduleRequestCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *UnifiedRoleEligibilityScheduleRequestCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleEligibilityScheduleRequestCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UnifiedRoleEligibilityScheduleRequestCollectionResponse) SetOdataNextLink(value *string) {
