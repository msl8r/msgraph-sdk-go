...
func (m *PrintTaskTriggerCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrintTaskTriggerCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrintTaskTriggerCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrintTaskTriggerCollectionResponse) SetOdataNextLink(value *string) {
