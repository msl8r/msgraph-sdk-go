...
func (m *UnifiedRoleManagementPolicyAssignmentCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *UnifiedRoleManagementPolicyAssignmentCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleManagementPolicyAssignmentCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UnifiedRoleManagementPolicyAssignmentCollectionResponse) SetOdataNextLink(value *string) {
