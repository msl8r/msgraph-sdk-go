...
func (m *AgreementFileVersionCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *AgreementFileVersionCollectionResponse) SetAdditionalData(value map[string]interface{}) {
