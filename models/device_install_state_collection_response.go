...
func (m *DeviceInstallStateCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceInstallStateCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceInstallStateCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceInstallStateCollectionResponse) SetOdataNextLink(value *string) {
