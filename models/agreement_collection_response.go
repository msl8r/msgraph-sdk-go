...
func (m *AgreementCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *AgreementCollectionResponse) GetOdataNextLink() *string {
...
func (m *AgreementCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AgreementCollectionResponse) SetOdataNextLink(value *string) {
