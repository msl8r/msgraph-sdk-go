...
func (m *TokenIssuancePolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *TokenIssuancePolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
