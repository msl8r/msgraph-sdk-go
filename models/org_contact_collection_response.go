...
func (m *OrgContactCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OrgContactCollectionResponse) GetOdataNextLink() *string {
...
func (m *OrgContactCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OrgContactCollectionResponse) SetOdataNextLink(value *string) {
