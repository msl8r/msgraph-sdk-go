...
func (m *PlannerBucketCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PlannerBucketCollectionResponse) GetOdataNextLink() *string {
...
func (m *PlannerBucketCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PlannerBucketCollectionResponse) SetOdataNextLink(value *string) {
