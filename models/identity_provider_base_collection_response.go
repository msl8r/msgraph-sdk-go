...
func (m *IdentityProviderBaseCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *IdentityProviderBaseCollectionResponse) GetOdataNextLink() *string {
...
func (m *IdentityProviderBaseCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *IdentityProviderBaseCollectionResponse) SetOdataNextLink(value *string) {
