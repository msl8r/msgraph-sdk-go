...
func (m *DeviceComplianceActionItemCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceComplianceActionItemCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceComplianceActionItemCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceComplianceActionItemCollectionResponse) SetOdataNextLink(value *string) {
