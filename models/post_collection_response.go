...
func (m *PostCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PostCollectionResponse) GetOdataNextLink() *string {
...
func (m *PostCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PostCollectionResponse) SetOdataNextLink(value *string) {
