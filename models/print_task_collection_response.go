...
func (m *PrintTaskCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrintTaskCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrintTaskCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrintTaskCollectionResponse) SetOdataNextLink(value *string) {
