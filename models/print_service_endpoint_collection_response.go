...
func (m *PrintServiceEndpointCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrintServiceEndpointCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrintServiceEndpointCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrintServiceEndpointCollectionResponse) SetOdataNextLink(value *string) {
