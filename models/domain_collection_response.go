...
func (m *DomainCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DomainCollectionResponse) GetOdataNextLink() *string {
...
func (m *DomainCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DomainCollectionResponse) SetOdataNextLink(value *string) {
