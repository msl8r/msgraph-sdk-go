...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UnifiedRoleManagementPolicyRuleCollectionResponse) SetOdataNextLink(value *string) {
