...
func (m *EducationUserCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationUserCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationUserCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationUserCollectionResponse) SetOdataNextLink(value *string) {
