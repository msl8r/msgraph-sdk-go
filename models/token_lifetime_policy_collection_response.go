...
func (m *TokenLifetimePolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *TokenLifetimePolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
