...
func (m *EducationRubricCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationRubricCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationRubricCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationRubricCollectionResponse) SetOdataNextLink(value *string) {
