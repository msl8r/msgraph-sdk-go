...
func (m *DeviceCompliancePolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceCompliancePolicyCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceCompliancePolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceCompliancePolicyCollectionResponse) SetOdataNextLink(value *string) {
