...
func (m *DeviceComplianceSettingStateCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceComplianceSettingStateCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceComplianceSettingStateCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceComplianceSettingStateCollectionResponse) SetOdataNextLink(value *string) {
