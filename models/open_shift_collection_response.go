...
func (m *OpenShiftCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OpenShiftCollectionResponse) GetOdataNextLink() *string {
...
func (m *OpenShiftCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OpenShiftCollectionResponse) SetOdataNextLink(value *string) {
