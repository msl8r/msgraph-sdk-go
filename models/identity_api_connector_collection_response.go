...
func (m *IdentityApiConnectorCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *IdentityApiConnectorCollectionResponse) GetOdataNextLink() *string {
...
func (m *IdentityApiConnectorCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *IdentityApiConnectorCollectionResponse) SetOdataNextLink(value *string) {
