...
func (m *EducationClassCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationClassCollectionResponse) SetAdditionalData(value map[string]interface{}) {
