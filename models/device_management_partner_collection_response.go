...
func (m *DeviceManagementPartnerCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceManagementPartnerCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceManagementPartnerCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceManagementPartnerCollectionResponse) SetOdataNextLink(value *string) {
