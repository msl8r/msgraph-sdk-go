...
func (m *DomainDnsRecordCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DomainDnsRecordCollectionResponse) GetOdataNextLink() *string {
...
func (m *DomainDnsRecordCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DomainDnsRecordCollectionResponse) SetOdataNextLink(value *string) {
