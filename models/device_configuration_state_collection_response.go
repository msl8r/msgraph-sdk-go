...
func (m *DeviceConfigurationStateCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceConfigurationStateCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceConfigurationStateCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceConfigurationStateCollectionResponse) SetOdataNextLink(value *string) {
