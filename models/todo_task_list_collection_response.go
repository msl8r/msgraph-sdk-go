...
func (m *TodoTaskListCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *TodoTaskListCollectionResponse) GetOdataNextLink() *string {
...
func (m *TodoTaskListCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *TodoTaskListCollectionResponse) SetOdataNextLink(value *string) {
