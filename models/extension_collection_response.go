...
func (m *ExtensionCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ExtensionCollectionResponse) SetAdditionalData(value map[string]interface{}) {
