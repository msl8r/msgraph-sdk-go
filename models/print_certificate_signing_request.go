...
func NewPrintCertificateSigningRequest() *PrintCertificateSigningRequest {
	...
	odataTypeValue := "#microsoft.graph.printCertificateSigningRequest"
...
func (m *PrintCertificateSigningRequest) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["transportKey"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetStringValue()
		if err != nil {
			return err
		}
...
func (m *PrintCertificateSigningRequest) GetOdataType() *string {
	return m.odataType
}
...
func (m *PrintCertificateSigningRequest) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *PrintCertificateSigningRequest) SetOdataType(value *string) {
	m.odataType = value
}
