...
func (m *ActivityBasedTimeoutPolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ActivityBasedTimeoutPolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
