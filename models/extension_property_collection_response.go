...
func (m *ExtensionPropertyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ExtensionPropertyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
