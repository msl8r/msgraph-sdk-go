...
func (m *OnlineMeetingCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OnlineMeetingCollectionResponse) GetOdataNextLink() *string {
...
func (m *OnlineMeetingCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OnlineMeetingCollectionResponse) SetOdataNextLink(value *string) {
