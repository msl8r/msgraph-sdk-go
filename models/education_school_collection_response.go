...
func (m *EducationSchoolCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationSchoolCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationSchoolCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationSchoolCollectionResponse) SetOdataNextLink(value *string) {
