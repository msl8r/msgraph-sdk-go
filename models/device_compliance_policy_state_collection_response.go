...
func (m *DeviceCompliancePolicyStateCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceCompliancePolicyStateCollectionResponse) SetOdataNextLink(value *string) {
