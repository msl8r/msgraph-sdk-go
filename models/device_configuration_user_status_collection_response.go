...
func (m *DeviceConfigurationUserStatusCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceConfigurationUserStatusCollectionResponse) SetAdditionalData(value map[string]interface{}) {
