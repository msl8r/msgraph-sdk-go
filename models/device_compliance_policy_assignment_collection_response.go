...
func (m *DeviceCompliancePolicyAssignmentCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceCompliancePolicyAssignmentCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceCompliancePolicyAssignmentCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceCompliancePolicyAssignmentCollectionResponse) SetOdataNextLink(value *string) {
