...
func (m *TrendingCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *TrendingCollectionResponse) GetOdataNextLink() *string {
...
func (m *TrendingCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *TrendingCollectionResponse) SetOdataNextLink(value *string) {
