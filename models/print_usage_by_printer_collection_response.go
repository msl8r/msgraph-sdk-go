...
func (m *PrintUsageByPrinterCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *PrintUsageByPrinterCollectionResponse) GetOdataNextLink() *string {
...
func (m *PrintUsageByPrinterCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *PrintUsageByPrinterCollectionResponse) SetOdataNextLink(value *string) {
