...
func (m *OpenShiftChangeRequestCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *OpenShiftChangeRequestCollectionResponse) GetOdataNextLink() *string {
...
func (m *OpenShiftChangeRequestCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *OpenShiftChangeRequestCollectionResponse) SetOdataNextLink(value *string) {
