...
func (m *UnifiedRoleAssignmentCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *UnifiedRoleAssignmentCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleAssignmentCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UnifiedRoleAssignmentCollectionResponse) SetOdataNextLink(value *string) {
