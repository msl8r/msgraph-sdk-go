...
func (m *ProfilePhotoCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ProfilePhotoCollectionResponse) GetOdataNextLink() *string {
...
func (m *ProfilePhotoCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *ProfilePhotoCollectionResponse) SetOdataNextLink(value *string) {
