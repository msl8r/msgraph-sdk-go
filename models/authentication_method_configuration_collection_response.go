...
func (m *AuthenticationMethodConfigurationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *AuthenticationMethodConfigurationCollectionResponse) GetOdataNextLink() *string {
...
func (m *AuthenticationMethodConfigurationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *AuthenticationMethodConfigurationCollectionResponse) SetOdataNextLink(value *string) {
