...
func (m *DirectoryObjectCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DirectoryObjectCollectionResponse) GetOdataNextLink() *string {
...
func (m *DirectoryObjectCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DirectoryObjectCollectionResponse) SetOdataNextLink(value *string) {
