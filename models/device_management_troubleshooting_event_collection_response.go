...
func (m *DeviceManagementTroubleshootingEventCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceManagementTroubleshootingEventCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceManagementTroubleshootingEventCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceManagementTroubleshootingEventCollectionResponse) SetOdataNextLink(value *string) {
