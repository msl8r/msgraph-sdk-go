...
func (m *EmailAuthenticationMethodCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EmailAuthenticationMethodCollectionResponse) GetOdataNextLink() *string {
...
func (m *EmailAuthenticationMethodCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EmailAuthenticationMethodCollectionResponse) SetOdataNextLink(value *string) {
