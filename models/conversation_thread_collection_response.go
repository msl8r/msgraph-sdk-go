...
func (m *ConversationThreadCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *ConversationThreadCollectionResponse) GetOdataNextLink() *string {
...
func (m *ConversationThreadCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *ConversationThreadCollectionResponse) SetOdataNextLink(value *string) {
