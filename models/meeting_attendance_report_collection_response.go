...
func (m *MeetingAttendanceReportCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *MeetingAttendanceReportCollectionResponse) GetOdataNextLink() *string {
...
func (m *MeetingAttendanceReportCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *MeetingAttendanceReportCollectionResponse) SetOdataNextLink(value *string) {
