...
func (m *DeviceAndAppManagementRoleAssignmentCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceAndAppManagementRoleAssignmentCollectionResponse) SetAdditionalData(value map[string]interface{}) {
