...
func (m *FederatedIdentityCredentialCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *FederatedIdentityCredentialCollectionResponse) GetOdataNextLink() *string {
...
func (m *FederatedIdentityCredentialCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *FederatedIdentityCredentialCollectionResponse) SetOdataNextLink(value *string) {
