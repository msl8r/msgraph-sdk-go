...
func (m *WindowsHelloForBusinessAuthenticationMethodCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *WindowsHelloForBusinessAuthenticationMethodCollectionResponse) GetOdataNextLink() *string {
...
func (m *WindowsHelloForBusinessAuthenticationMethodCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WindowsHelloForBusinessAuthenticationMethodCollectionResponse) SetOdataNextLink(value *string) {
