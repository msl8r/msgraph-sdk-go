...
func (m *EducationAssignmentResourceCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationAssignmentResourceCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationAssignmentResourceCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationAssignmentResourceCollectionResponse) SetOdataNextLink(value *string) {
