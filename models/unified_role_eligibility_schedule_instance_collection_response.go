...
func (m *UnifiedRoleEligibilityScheduleInstanceCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleEligibilityScheduleInstanceCollectionResponse) SetOdataNextLink(value *string) {
