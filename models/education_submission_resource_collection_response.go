...
func (m *EducationSubmissionResourceCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationSubmissionResourceCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationSubmissionResourceCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationSubmissionResourceCollectionResponse) SetOdataNextLink(value *string) {
