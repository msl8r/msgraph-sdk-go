...
func (m *EducationSubmissionCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *EducationSubmissionCollectionResponse) GetOdataNextLink() *string {
...
func (m *EducationSubmissionCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *EducationSubmissionCollectionResponse) SetOdataNextLink(value *string) {
