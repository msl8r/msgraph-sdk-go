...
func (m *DriveCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DriveCollectionResponse) GetOdataNextLink() *string {
...
func (m *DriveCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DriveCollectionResponse) SetOdataNextLink(value *string) {
