...
func (m *HomeRealmDiscoveryPolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *HomeRealmDiscoveryPolicyCollectionResponse) GetOdataNextLink() *string {
...
func (m *HomeRealmDiscoveryPolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *HomeRealmDiscoveryPolicyCollectionResponse) SetOdataNextLink(value *string) {
