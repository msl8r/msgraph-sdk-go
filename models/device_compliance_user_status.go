...
// DeviceComplianceUserStatus provides operations to manage the collection of agreement entities.
...
func NewDeviceComplianceUserStatus() *DeviceComplianceUserStatus {
	...
	odataTypeValue := "#microsoft.graph.deviceComplianceUserStatus"
