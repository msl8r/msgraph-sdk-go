...
func (m *DeviceConfigurationCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DeviceConfigurationCollectionResponse) GetOdataNextLink() *string {
...
func (m *DeviceConfigurationCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DeviceConfigurationCollectionResponse) SetOdataNextLink(value *string) {
