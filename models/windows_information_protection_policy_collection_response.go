...
func (m *WindowsInformationProtectionPolicyCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *WindowsInformationProtectionPolicyCollectionResponse) GetOdataNextLink() *string {
...
func (m *WindowsInformationProtectionPolicyCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WindowsInformationProtectionPolicyCollectionResponse) SetOdataNextLink(value *string) {
