...
func (m *DirectoryRoleCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *DirectoryRoleCollectionResponse) GetOdataNextLink() *string {
...
func (m *DirectoryRoleCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *DirectoryRoleCollectionResponse) SetOdataNextLink(value *string) {
