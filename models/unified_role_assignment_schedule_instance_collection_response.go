...
func (m *UnifiedRoleAssignmentScheduleInstanceCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *UnifiedRoleAssignmentScheduleInstanceCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleAssignmentScheduleInstanceCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *UnifiedRoleAssignmentScheduleInstanceCollectionResponse) SetOdataNextLink(value *string) {
