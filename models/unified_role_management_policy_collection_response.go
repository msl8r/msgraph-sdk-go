...
func (m *UnifiedRoleManagementPolicyCollectionResponse) GetOdataNextLink() *string {
...
func (m *UnifiedRoleManagementPolicyCollectionResponse) SetOdataNextLink(value *string) {
