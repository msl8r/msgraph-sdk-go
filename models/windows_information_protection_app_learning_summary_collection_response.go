...
func (m *WindowsInformationProtectionAppLearningSummaryCollectionResponse) GetAdditionalData() map[string]interface{} {
...
func (m *WindowsInformationProtectionAppLearningSummaryCollectionResponse) GetOdataNextLink() *string {
...
func (m *WindowsInformationProtectionAppLearningSummaryCollectionResponse) SetAdditionalData(value map[string]interface{}) {
	m.additionalData = value
}

// SetOdataNextLink sets the @odata.nextLink property value. The OdataNextLink property
func (m *WindowsInformationProtectionAppLearningSummaryCollectionResponse) SetOdataNextLink(value *string) {
