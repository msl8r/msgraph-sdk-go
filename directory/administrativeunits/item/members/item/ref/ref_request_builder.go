...
// RefRequestBuilderDeleteQueryParameters delete ref of navigation property members for directory
type RefRequestBuilderDeleteQueryParameters struct {
	// Delete Uri
...
func NewRefRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *RefRequestBuilder {
	m := &RefRequestBuilder{}
	m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/$ref{?%40id}"
...
// CreateDeleteRequestInformation delete ref of navigation property members for directory
...
// CreateDeleteRequestInformationWithRequestConfiguration delete ref of navigation property members for directory
...
// DeleteWithRequestConfigurationAndResponseHandler delete ref of navigation property members for directory
