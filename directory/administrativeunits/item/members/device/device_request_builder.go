...
import (
	...
	ied274a637f9f7e5bd4bcf2b4916bfbc76bdd0ee2542dfdcd01cf7821bd02d042 "github.com/microsoftgraph/msgraph-sdk-go/directory/administrativeunits/item/members/device/count"
...
func NewDeviceRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *DeviceRequestBuilder {
	...
	m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
...
func (m *DeviceRequestBuilder) Count() *ied274a637f9f7e5bd4bcf2b4916bfbc76bdd0ee2542dfdcd01cf7821bd02d042.CountRequestBuilder {
	return ied274a637f9f7e5bd4bcf2b4916bfbc76bdd0ee2542dfdcd01cf7821bd02d042.NewCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *DeviceRequestBuilder) Get() (iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DeviceCollectionResponseable, error) {
